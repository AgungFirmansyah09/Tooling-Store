<?php 
  ...
  if ( data_master_pad_press ($_POST) >0) {
   $success = true;
  } else {
   $error = true;
  }
...
if(isset($_FILES['namafile']['name']) && in_array($_FILES['namafile']['type'], $file_mimes)) {
    ...
    {
        $model = $sheetData[$i]['1'];
        mysqli_query($conn,"INSERT INTO data_master_pad_press (id, model) values ('','$model')");
    }
    header("Location: data-master-pad-press.php"); 
}
?>
<!-- End Upload -->
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Created Data Master Pad Press</h3>
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-12 col-sm-12">
                <td>
                <button type="submit" name="submit" class="btn btn-success toastrDefaultSuccess"><i class="fas fa-share-square"></i> Submit</button>
      ...
      <div class="card card-default">
          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="col-12 col-sm-6">
                ...
                <a onclick="JavaScript:window.location.href='download.php?file=master-data/data_master_pad_press.xlsx';" class="btn btn-primary">
       ...
       <div class="row">
          <div class="col-12 col-sm-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Master data Pad Press</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form action="delete-all-data-master-pad-press.php" method="post">
                <table id="example1" class="table table-bordered table-striped">
                  <?php 
                    $data_user = mysqli_query($conn,"SELECT * FROM data_master_pad_press");
                   ?>
                  <thead>
                    <tr>
                  ...
                  <?php 
                  $total = mysqli_query($conn, "SELECT * FROM data_master_pad_press ORDER BY id DESC");
                  ?>
                  <tbody>
                    <?php $i=1; ?>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="delete_data_master_pad_press.php?id=<?php echo $row['id']; ?>"  
