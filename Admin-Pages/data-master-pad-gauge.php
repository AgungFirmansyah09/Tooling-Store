<?php 
  ...
  if ( data_master_pad_gauge ($_POST) >0) {
   $success = true;
  } else {
   $error = true;
  }
...
if(isset($_FILES['namafile']['name']) && in_array($_FILES['namafile']['type'], $file_mimes)) {
    ...
    {
        $model = $sheetData[$i]['1'];
        mysqli_query($conn,"INSERT INTO data_master_pad_gauge (id, model) values ('','$model')");
    }
    header("Location: data-master-pad-gauge.php"); 
}
?>
<!-- End Upload -->
      ...
      <div class="card card-default">
          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="col-12 col-sm-6">
                ...
                <a onclick="JavaScript:window.location.href='download.php?file=master-data/data_master_pad_gauge.xlsx';" class="btn btn-primary">
       ...
       <div class="row">
          <div class="col-12 col-sm-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Master data Pad Gauge</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form action="delete-all-data-master-pad-gauge.php" method="post">
                <table id="example1" class="table table-bordered table-striped">
                  <?php 
                    $data_user = mysqli_query($conn,"SELECT * FROM data_master_pad_gauge");
                   ?>
                  <thead>
                    <tr>
                  ...
                  <?php 
                  $total = mysqli_query($conn, "SELECT * FROM data_master_pad_gauge ORDER BY id DESC");
                  ?>
                  <tbody>
                    <?php $i=1; ?>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="delete_data_master_pad_gauge.php?id=<?php echo $row['id']; ?>"  
