      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">RESULT QR-CODE</h3>
          ...
          <div class="card-body" style="text-align: center;">
            ...
            <img src="QR-code/<?php echo $_GET['success']; ?>" alt="">
            ...
            <a class="btn btn-primary" href="download-qr.php?download=<?php echo $_GET['success']; ?>"><i class="fas fa-cloud-download-alt"></i> Download Now</a>
            <!-- <a class="btn btn-info" href="" ><i class="fas fa-print"></i> Print Now</a> -->
          </div>
            <?php
          }
            ?>
