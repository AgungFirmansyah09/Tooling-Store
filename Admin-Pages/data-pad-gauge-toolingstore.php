          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Pad Gauge data Tooling Store</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <?php 
                  $total = mysqli_query($conn, "SELECT * FROM print_qr_pad_gauge WHERE lokasi ='TOOLING STORE' ORDER BY id DESC");
                ?>
