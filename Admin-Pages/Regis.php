...
<head>
  ...
  <title>Tooling-Store | Registration</title>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Registration users...! </h3>
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <select class="form-control select2" style="width: 100%;" name="level" required="">
                    ...
                    <option value="General Manager">General Manager & Direktur</option>
                    <option value="Direktur">Direktur</option>
                    <option value="Persiden Direktur">Presiden Direktur</option>
                  </select>
                </div>
              </div>
              ...
              <div class="col-12 col-sm-12">
                <div class="input-group">
                  <div class="custom-file">
                    ...
                    <label class="custom-file-label">Images user</label>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  <?php 
                    $data_user = mysqli_query($conn,"SELECT * FROM user_otorisasi");
                   ?>
                  <thead>
                    <tr>
                      <th>No</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $row ["level"]; ?></td>
                       ...
                       <td>
                        <center>
                        <img src="../img_uplaod/<?php echo $row ["gambar"]; ?>" class="img-circle elevation-2"  alt="User Image" width="40px">
                        </center>
                      </td> 
                      ...
                      <td>
                        <center>
                          ...
                          <a href="profile.php?id=<?=$row ["id"];?>" class="btn btn-info btn-sm" data-toggle='tooltip' title="View Data">
