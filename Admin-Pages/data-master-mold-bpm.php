<?php 
  ...
  if ( data_master_mold_bpm ($_POST) >0) {
    $success = true;
  } else {
    $error = true;
  }
...
if(isset($_FILES['namafile']['name']) && in_array($_FILES['namafile']['type'], $file_mimes)) {
    ...
    {
        $model = $sheetData[$i]['1'];
        $kode_mold = $sheetData[$i]['2'];

        mysqli_query($conn,"INSERT INTO data_master_mold_bpm (id, model, kode_mold) values ('','$model','$kode_mold')");
    }
    header("Location: data-master-mold-bpm.php"); 
}
?>
<!-- End Upload -->
            ...
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control auto-save" name="kode_mold" placeholder="kode mold" required="">
                </div>
              </div>
             </div>
      ...
      <div class="card card-default">
          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="col-12 col-sm-6">
                ...
                <a onclick="JavaScript:window.location.href='download.php?file=master-data/data_master_mold_bpm.xlsx';" class="btn btn-primary">
       ...
       <div class="row">
          <div class="col-12 col-sm-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Master data Mold BPM</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form action="delete-all-data-master-mold-bpm.php" method="post">
                <table id="example1" class="table table-bordered table-striped">
                  <?php 
                    $data_user = mysqli_query($conn,"SELECT * FROM data_master_mold_bpm ");
                   ?>
                  <thead>
                    <tr>
                  ...
                  <?php 
                  $total = mysqli_query($conn, "SELECT * FROM data_master_mold_bpm ORDER BY id DESC");
                  ?>
                  <tbody>
                    <?php $i=1; ?>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="delete_data_master_mold_bpm.php?id=<?php echo $row['id']; ?>"  
