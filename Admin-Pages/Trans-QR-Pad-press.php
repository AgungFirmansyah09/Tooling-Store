    ...
    <div class="container-fluid">
      ...
      <div class="card card-default">
        <div class="card-header">
          <h3 class="card-title">TRANSACTION DATA PAD PRESS</h3>
        ...
        <hr>
          <div class="row">
            <div class="col-12 col-sm-12">
              <?php if (isset($_SESSION ['username'])) : ?>
              <td>
                <a href="ncvs_proses_pad_press.php?id=<?php echo $edit['id']?>" class="btn btn-danger">
                  <i class="fas fa-share-square"></i> OUT NCVS
                </a>
                <a href="tooling_proses_pad_press.php?id=<?php echo $edit['id']?>" class="btn btn-success">
                  <i class="fas fa-sign-in-alt"></i> IN STORE
                </a>
                <a href="return_proses_pad_press.php?id=<?php echo $edit['id']?>" class="btn btn-warning">
