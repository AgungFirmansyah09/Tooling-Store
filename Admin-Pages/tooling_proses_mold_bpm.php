<?php 
  ...
  if ( tooling_proses_mold_bpm ($_POST) >0) {
   $success = true;
  } else {
    $error = true;
  }
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title bg-success">TRANSACTION TOOLING STORE</h3>
          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data">
              ...
              <input type="hidden" name="kode_mold" id="kode_mold" value="<?php echo $edit["kode_mold"]; ?>">
              ...
              <input type="hidden" name="lokasi" id="lokasi" value="TOOLING STORE">
