<?php 
  ...
  $edit = query ("SELECT * FROM print_qr_mold_bpm WHERE id = $id")[0];
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <?php if (isset($_SESSION ['username'])) : ?>
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="../Login.php" class="d-block">Hello User</a>
        </div>
      </div>
    <?php endif ?>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-header">USER SESSION</li>
          <li class="nav-item">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-header">LOGIN NOW</li>
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="far fa-registered"></i>
              <p>
    ...
    <div class="container-fluid">
      ...
      <div class="card card-default">
        <div class="card-header">
          <h3 class="card-title">TRANSACTION DATA MOLD BPM</h3>
        ...
        <hr>
          <div class="row">
            <div class="col-12 col-sm-12">
              <?php if (isset($_SESSION ['username'])) : ?>
              <td>
                <a href="ncvs_proses_mold_bpm.php?id=<?php echo $edit['id']?>" class="btn btn-danger">
                  <i class="fas fa-share-square"></i> OUT NCVS
                </a>
                <a href="tooling_proses_mold_bpm.php?id=<?php echo $edit['id']?>" class="btn btn-success">
                  <i class="fas fa-sign-in-alt"></i> IN STORE
                </a>
                <a href="return_proses_mold_bpm.php?id=<?php echo $edit['id']?>" class="btn btn-warning">
                  <i class="fas fa-undo-alt"></i> RETURN
                </a>
              </td> 
              <?php else: ?>
                <td>
                  <p>If you want to make a transaction, please <a href="..\login.php">login.</a></p>
                </td>                
              <?php endif ?>
            </div>   
          </div>             
