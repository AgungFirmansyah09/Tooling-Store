  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0" style="color: blue;"><i class="fas fa-print"></i> Print Barcode</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                ...
                <p>Created Barcode C/T Dies</p>
              </div>
              <div class="icon">
                <i class="fas fa-dice-d6"></i>
              </div>
              <a href="print-bercode-cutting-dies.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-gray">
              <div class="inner">
                ...
                <p>Created Barcode Pallet CSC</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                ...
                <p>Created Barcode Pallet Nosew</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-pink">
              <div class="inner">
                ...
                <p>Created Barcode Pallet M-Skiv</p>
              </div>
              <div class="icon">
                <i class="fas fa-pallet"></i>
              </div>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-dark">
              <div class="inner">
                ...
                <p>Created Barcode Hand Punch</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-lightblue">
              <div class="inner">
                ...
                <p>Created Barcode Pad Press</p>
              </div>
              <div class="icon">
                <i class="fas fa-compress-arrows-alt"></i>
              </div>
              <a href="print-barcode-pad-press.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-purple">
              <div class="inner">
                ...
                <p>Created Barcode Pad Gauge</p>
              </div>
              <div class="icon">
                <i class="fas fa-sign-language"></i>
              </div>
              <a href="print-barcode-pad-gauge.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-primary">
              <div class="inner">
                ...
                <p>Created Barcode Mold BPM</p>
              </div>
              <div class="icon">
                <i class="fab fa-modx"></i>
              </div>
              <a href="print-barcode-mold-bpm.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
