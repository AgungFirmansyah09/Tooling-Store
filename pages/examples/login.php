...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.php" style="color:darkblue;">
      <b style="color:blue;">Tooling</b>
    STORE

    <i class="fas fa-cogs"></i> <i class="fas fa-tools"></i>
  </a> 
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <div class="col-4">
       ...
       <center>
          <h5><img src="../../docs/assets/img/Logo-ADF.png" width="15%"> PT.ADIS DIMENSION FOOTWEAR</h5>
       </center>
