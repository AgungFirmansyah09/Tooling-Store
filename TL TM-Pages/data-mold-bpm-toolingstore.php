  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Inventory Tooling Store</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Inventory Tooling Store</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Mold BPM data Tooling Store</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <?php 
                  $total = mysqli_query($conn, "SELECT * FROM print_qr_mold_bpm WHERE lokasi ='TOOLING STORE' ORDER BY id DESC");
                ?>
