          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Cutting Dies data Tooling Store</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <?php 
                  $total = mysqli_query($conn, "SELECT * FROM print_qr_ct_dies WHERE lokasi ='TOOLING STORE' ORDER BY id DESC");
                ?>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th><center>Style color</center></th>
