  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">CUTTING DIES</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Cutting Dies</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-primary">
              <div class="inner">
                ...
                <p>Incoming Tools to tooling store</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                ...
                <p>Come out Tools in Tooling Store to NCVS</p>
              </div>
              <div class="icon">
                <i class="fas fa-sign-out-alt"></i>
              </div>
              <a href="c-dies-transaction.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-6">
